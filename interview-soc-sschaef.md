...
I prioritize my work by prefering issues which impact a large number of users and are unlikely to be tackled by others.
...
I'm usually very busy and have a lot of other important priorities (family, friends, university, ...), so I have to focus on getting things done; I don't really experiment much in the Scala space.

Sadly, the only thing I get in return are more ideas on what to work on. :-)
Like when I was traveling back from ScalaDays Amsterdam with Simon and Mathias Doenitz, and realized that there seemed to be no regular Scala conference in Germany – unlike many other European countries with one to three conferences each year!
...
**Simon Ochsenreither**: What I like about open-source development is the community, the chance to have a positive impact on a lot of people, the ability to decide on what to work on, the lack of office politics and the focus on using the best tools for the job (Scala, Git & GitHub, Continuous Integration, Testing, ...) – and then automating it.

It might be challenging to find companies which are at least sympathetic to these values, but I'm not too concerned about it right now. Being self-employed or starting my own company is certainly an option, too.
...
**Simon Schäfer**: I fear that working on tools is the only thing I would enjoy on a longer time period. I'm more or less only interested in working on software that either gives me technical knowledge or improves my own life. Working on tools has the advantage that you immediately can use your own improvements – this means that nearly everything I did for Scala IDE has its origin in my own desire to use it by myself. I'd also like to stay in the open source world because it makes it easy to contribute the changes I desire.
